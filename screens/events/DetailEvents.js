    ...
    <View style={styles.container}>
      ...
      <View style={{ height: "100%" }}>
        <ScrollView
          ...
          {refreshing ? (
            <SkeletonDetailEvents circleAnimatedValue={circleAnimatedValue} />
          ) : (
              ...
              <View
                ...
                <View
                  style={{
                    ...
                    marginTop: 10,
                    marginHorizontal:
                      auth.permission.group_id == Admin ? 15 : 0,
                  }}>
                  <TouchableOpacity
                    style={{
                      paddingHorizontal: 5,
                  ...
                  <TouchableOpacity
                    ...
                    {event.detailEvent?.ds_tham_gia?.length > 0 && (
                      <View
                        ...
                        {event.detailEvent?.ds_tham_gia?.length >= 1 && (
                          <Image
                            source={
                            ...
                            style={{
                              ...
                              borderRadius: 20,
                              left:
                                event.detailEvent?.ds_tham_gia?.length === 2
                                  ? 8
                                  : event.detailEvent?.ds_tham_gia?.length === 1
                                  ? 0
                                  : 14,
